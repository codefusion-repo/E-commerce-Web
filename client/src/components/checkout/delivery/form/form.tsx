  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <option value={undefined}>Select a commune</option>
          {communes &&
      ...
      >
        ...
        <PhoneInput
          placeholder={!isPhoneDefault ? "Enter a phone number" : user?.phone}
          name="phoneNumber"
          id="phoneNumber"
          value={phoneNumber}
          onChange={(e) => onChange(e)}
      ...
      {user && user.phone && (
        ...
        >
          <h4>Use default phone number?</h4>
